...
-- at runtime using the environment variable fp_lab2_bindir.
...
-- environment variable fp_lab2_libdir.
...
-- using the environment variable fp_lab2_dynlibdir.
...
-- runtime using the environment variable fp_lab2_datadir.
...
-- using the environment variable fp_lab2_sysconfdir.
...
libdir     = "/Users/trikesh/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace/fp-lab2-0.1.0.0-inplace-fp-lab2-test"
dynlibdir  = "/Users/trikesh/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace"
datadir    = "/Users/trikesh/.cabal/share/aarch64-osx-ghc-9.12.2-inplace/fp-lab2-0.1.0.0"
libexecdir = "/Users/trikesh/.cabal/libexec/aarch64-osx-ghc-9.12.2-inplace/fp-lab2-0.1.0.0"
sysconfdir = "/Users/trikesh/.cabal/etc"

getBinDir     = catchIO (getEnv "fp_lab2_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "fp_lab2_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "fp_lab2_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "fp_lab2_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "fp_lab2_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "fp_lab2_sysconfdir") (\_ -> return sysconfdir)
